      ...
      <div className="mb-8 flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600">
            Chúc bạn một ngày làm việc hiệu quả. Dưới đây là các nhật ký mới nhất về Minh Anh.
          </p>
        </div>
        <div className="flex gap-3">
          <button className="bg-[#0B3D5C] hover:bg-[#0A2E47] text-white px-6 py-3 rounded-lg font-semibold flex items-center gap-2 transition">
            <span>📧</span>
            <span>Liên hệ Giáo viên Chủ nhiệm</span>
          </button>
          <button className="bg-white border border-gray-300 text-gray-900 px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-gray-50 transition">
            <span>⬇️</span>
        ...
        <div className="col-span-2 space-y-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Kinh môi quỳ phụ huynh tham dự buổi chia sẻ về lộ trình đào...</p>
          ...
          <div className="bg-gradient-to-r from-[#0B3D5C] to-[#0066CC] rounded-lg border border-[#0066CC] p-6 text-white">
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <div className="text-sm font-semibold uppercase opacity-90 mb-2">TIN NHẬN TỪ SỐ DẠO ĐẠI</div>
                <h3 className="text-lg font-bold mb-3">Lời khên từ Giáo viên</h3>
                <p className="text-sm leading-relaxed mb-4">
                  "Minh Anh có thái độ học tập tích cực trong tiết Toán hôm nay. Em đã giải được bài toán nâng cao 10 công!" - Thầy Trần Hoàng Nam - GV Toán
                </p>
            ...
            <div className="text-center py-6">
              <div className="w-32 h-32 mx-auto rounded-full border-8 border-gray-200 flex items-center justify-center bg-gray-50">
                <div>
                  ...
                  <div className="text-xs text-gray-600">Tỳ lệ</div>
                </div>
              </div>
          ...
          <div className="bg-gray-900 text-white rounded-lg p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Sản phố hỗ trợ bạn</div>
              </div>
            </div>
