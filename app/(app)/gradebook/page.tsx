...
aiNote: 'Nhận xét từ AI: "Thực sự bạn có tiến bộ rõ rệt trong chương Hình học không gian. Điểm số đã tăng +0.2 so với tuần trước!"',
},
{
name: 'Ngữ văn',
...
aiNote: 'Nhận xét từ AI: "Cần chú ý hơn về lỗi chính tả và ngữ pháp. AI dự báo nếu cải thiện phần này, điểm cuối kỳ có thể đạt 8.8+"',
},
{
name: 'Tiếng Anh',
...
Minh Anh đang duy trì phong độ xuất sắc trong học kỳ này. Dựa trên dữ liệu số 4 tuần gần nhất, AI dự báo điểm mạnh +0.2 vào cuối kỳ. Các môn tự nhiên (Toán, Lý) có số bứt phá tỷ lệ.
</p>
...
<div className="text-xs text-gray-600 font-semibold mb-1">MIỆNG</div>
...
<div className="text-xs text-red-600 font-semibold mb-1">CUỐI KỲ</div>
...
Đặt lịch trò chuyện với giáo viên chủ nhiệm
</p>
...
<p className="text-sm text-gray-700 mb-4">
Lộ trình được cá nhân hóa dựa trên bảng điểm hiện tại
</p>
