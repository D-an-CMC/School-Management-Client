  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8 flex items-center gap-4 bg-white border border-gray-200 rounded-lg p-4">
        <label className="font-semibold text-gray-900">LỚP HỌC & MÔN HỌC</label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4">
          ...
          <div className="text-sm text-gray-900">Số học sinh</div>
          <div className="text-xs text-gray-700 mt-2">100% hoàn tất</div>
        </div>
        <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4">
          <div className="text-2xl font-bold text-green-600 mb-1">7.4 DTB</div>
          <div className="text-sm text-gray-900">Điểm trung bình lớp</div>
          <div className="text-xs text-gray-700 mt-2">85% hoàn tất</div>
        </div>
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-4">
          ...
          <div className="text-xs text-gray-900 mt-2">Số ngày nghỉ học để đăng ký khi AI phát hiện báo cáo</div>
        </div>
      </div>
            ...
            <tbody>
              {mockGrades.map((grade, index) => (
                <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-center text-gray-900">{grade.final}</td>
                  <td className="px-6 py-4 text-center">
