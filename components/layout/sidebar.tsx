...
export function Sidebar({ variant = 'default', onClose }: SidebarProps) {
  ...
  const adminNavItems = [
    ...
    { href: '/ai-configuration', label: 'AI Configuration', icon: 'M9.663 17h4.674a1 1 0 00.922-.606l7-15A1 1 0 0021.337 0H2.663a1 1 0 00-.922 1.394l7 15a1 1 0 00.922.606zM12 22v-5' },
    { href: '/security-logs', label: 'Security Logs', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  ]
    ...
    <aside className={baseClasses}>
      {!isIconOnly && (
        <div className="p-9 flex flex-col items-center">
          ...
          />
          <h1 className="text-lg font-bold text-center leading-tight">CMC University</h1>
          <p className="text-xs text-[#A0B4C8] text-center mt-1">Trường THCS CMC</p>
        </div>
      )}
