...
export function Sidebar({ variant = 'default', onClose }: SidebarProps) {
  ...
  const adminNavItems = [
    ...
    { href: '/user-management', label: 'Quản lý người dùng', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { href: '/system-permissions', label: 'Quản lý quyền hệ thống', icon: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z' },
